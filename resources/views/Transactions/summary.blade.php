            ...
            <div class="panel-body">
                ...
                <form class="form-horizontal" role="form"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-md-6 col-xs-5">
                            <label class="text-primary" for="first_name_value">{{$balance}}</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-md-6 col-xs-5">
                            <label class="text-primary" for="first_name_value">{{$request->amount}}</label>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-md-6 col-xs-5">
                            <label class="text-primary" for="first_name_value">{{$balance-$request->amount}}</label>
                        </div>
                    </div>
