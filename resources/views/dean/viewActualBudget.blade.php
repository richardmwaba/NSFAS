    ...
    <div class="row" xmlns="http://www.w3.org/1999/html">
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading text-info">Actual Budgets From all Units and Departments for The School of
                    <?php
                    use App\School;
                ...
                <div class="panel-body">
                    <div class="btn-group">
                        <a href="{{ route('actualBudgetReport') }}" class="btn btn-md btn-link"><i class="fa fa-print fa-fw text-success">
