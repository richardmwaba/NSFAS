                ...
                <ul class="nav" id="side-menu">
                    @section('sideMenu')@yield('menu')@show
                        ...
                        @if(Auth::user()->access_level_id == 'OT')
                            <li>
                                <a href="#"><i class="fa fa-info fa-fw"></i>Imprest<span
                                            class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                                        <a href="#"><i class="fa fa-info fa-fw"></i>info</a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-plus-circle fa-fw"></i>add</a>
                                    </li>
                                    <li>
                                        <a href="#"><i class="fa fa-gear fa-fw"></i>View Report</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{URL::asset('/ProjectReport')}}"><i class="fa fa-gear fa-fw"></i>View Report</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
